...
/// Opens the local-AI settings.
Future<void> showAiSettingsSheet(BuildContext context) => showDialog<void>(
  context: context,
    ...
    return AlertDialog(
      ...
      content: SizedBox(
        ...
        child: Column(
          ...
          children: <Widget>[
            Text(
              'Summaries, semantic search and question answering run against a '
              'model on this machine. Nothing is sent anywhere else, and the '
              'app is fully usable with this switched off.',
                  ...
                  : Column(
                      children: <Widget>[
                        ...
                        _ModelPicker(
                          ...
                          helper:
                              'Used for semantic search; changing it rebuilds '
                              'the index',
                          models: installed,
                          selected: settings.embeddingModel,
                          onChanged: (value) =>
                              _update(settings.copyWith(embeddingModel: value)),
                        ),
                      ],
                    ),
            ),
      ...
      actions: <Widget>[
        TextButton(
          onPressed: () => ref.invalidate(modelAvailabilityProvider),
